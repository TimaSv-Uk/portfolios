...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto flex items-center justify-center z-10">
      <div
      ...
      >
        {/* Text Section */}
        <div className="flex flex-row gap-4 items-center pt-40 sm:pt-0">
        ...
        <motion.div
          className="flex xs:flex-1 xs:h-auto md:h-[500px] h-[500px]"
